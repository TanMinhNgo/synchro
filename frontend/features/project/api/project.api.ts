...
export const projectApi = {
  async listProjects(): Promise<Project[]> {
    ...
    return items.map((p) =>
      normalizeId(p as Record<string, unknown> & MongoIdLike) as unknown as Project,
    );
  },

  async createProject(input: CreateProjectInput): Promise<Project> {
    const res = await apiClient.post('/projects', input);
    return normalizeId(res.data as Record<string, unknown> & MongoIdLike) as unknown as Project;
  },
  ...
  async listBoards(projectId: string): Promise<Board[]> {
    ...
    const items = Array.isArray(res.data) ? (res.data as Array<Record<string, unknown>>) : [];
    return items.map((b) =>
      normalizeId(b as Record<string, unknown> & MongoIdLike) as unknown as Board,
    );
  },

  async createBoard(projectId: string, input: CreateBoardInput): Promise<Board> {
    const res = await apiClient.post(`/projects/${projectId}/boards`, input);
    return normalizeId(res.data as Record<string, unknown> & MongoIdLike) as unknown as Board;
  },

  async listColumns(projectId: string, boardId: string): Promise<ProjectColumn[]> {
    const res = await apiClient.get(`/projects/${projectId}/boards/${boardId}/columns`);
    const items = Array.isArray(res.data) ? (res.data as Array<Record<string, unknown>>) : [];
    return items.map((c) =>
      normalizeId(c as Record<string, unknown> & MongoIdLike) as unknown as ProjectColumn,
    );
  },

  async createColumn(projectId: string, boardId: string, input: CreateColumnInput): Promise<ProjectColumn> {
    const res = await apiClient.post(`/projects/${projectId}/boards/${boardId}/columns`, input);
    return normalizeId(res.data as Record<string, unknown> & MongoIdLike) as unknown as ProjectColumn;
  },
  ...
  async listLabels(projectId: string): Promise<ProjectLabel[]> {
    ...
    const items = Array.isArray(res.data) ? (res.data as Array<Record<string, unknown>>) : [];
    return items.map((l) =>
      normalizeId(l as Record<string, unknown> & MongoIdLike) as unknown as ProjectLabel,
    );
  },

  async createLabel(projectId: string, input: CreateLabelInput): Promise<ProjectLabel> {
    const res = await apiClient.post(`/projects/${projectId}/labels`, input);
    return normalizeId(res.data as Record<string, unknown> & MongoIdLike) as unknown as ProjectLabel;
  },

...
export function TaskCalendarCard({ items, isLoading, isError }: { items: Item[]; isLoading: boolean; isError: boolean }) {
    const calendar = React.useMemo(() => {
        ...
        const tasks = items
            .map((it) => {
                ...
                const index = Math.floor((dueDay.getTime() - start.getTime()) / (24 * 60 * 60 * 1000));

...
type ActiveData = { taskId: string; columnKey: ProjectColumnKey; projectId: string };
...
export function TaskKanbanBoard({
    ...
    onOpen: (args: { task: Task; projectId: string; projectName: string }) => void;
    onDelete: (args: { task: Task; projectId: string }) => void;
}) {
    const transitionTaskMutation = useTransitionTask({
        getListQueryKey: (vars) =>
            userId && vars.projectId ? (['projects', vars.projectId, 'tasks', 'assignee', userId] as const) : undefined,
    });

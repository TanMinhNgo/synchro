...
export function DeleteTaskAlert({
    ...
    const deleteTaskMutation = useDeleteTask({
        listQueryKey:
            deleting && userId ? (['projects', deleting.projectId, 'tasks', 'assignee', userId] as const) : undefined,
    ...
    return (
        <AlertDialog open={Boolean(deleting)} onOpenChange={(open) => (!open ? onClose() : undefined)}>
            <AlertDialogContent>
                <AlertDialogHeader>

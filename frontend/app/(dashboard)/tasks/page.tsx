...
export default function MyTasksPage() {
  const { isLoading, isError, items, currentUserQuery, projectsQuery } =
    useMyTasksKanban();
    ...
    <div className="flex h-full flex-col gap-6 p-2">
      ...
      <div className="flex flex-col gap-4 mt-2">
        ...
        <TaskKanbanBoard
          ...
          onOpen={({ task, projectId, projectName }) =>
            setEditing({ task, projectId, projectName })
          }
      ...
      <EditTaskDialog
        ...
        userId={userId}
        onRequestDelete={({ task, projectId }) =>
          setDeleting({ task, projectId })
        }
      />

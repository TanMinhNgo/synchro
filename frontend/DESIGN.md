...
version: alpha
name: Signal Studio
description: Signal Studio is a bold, tactile product language that mixes warm neutrals with energetic coral and sea-glass accents. It favors airy canvas surfaces, soft glassy cards, and a subtle blueprint grid behind key workspaces. Typography combines Space Grotesk headings with Manrope body text, emphasizing confident structure and roomy layout. Motion is deliberate: soft page fades, gentle lift on cards, and focused ring glows for interactive elements.

colors:
  primary: "#f06a4f"
  primary-pressed: "#d45740"
  primary-deep: "#b24533"
  on-primary: "#fff8f1"
  brand-ink: "#131623"
  brand-ink-mid: "#242a3d"
  brand-sand: "#f4efe7"
  brand-sand-deep: "#e9e2d7"
  brand-sea: "#3bb6a6"
  brand-sea-deep: "#1d7f74"
  brand-sky: "#6aa9ff"
  brand-sun: "#f5c061"
  brand-lime: "#7bd389"
  canvas: "#fbf9f5"
  ...
  surface-soft: "#fdfaf6"
  hairline: "#e6ded2"
  hairline-soft: "#ede6db"
  hairline-strong: "#d8cfc2"
  ink-deep: "#0d1018"
  ink: "#1b2130"
  charcoal: "#2e3346"
  slate: "#5d647a"
  ...
  muted: "#a7adbd"
  on-dark: "#ffffff"
  on-dark-muted: "#b9c0d2"
  semantic-success: "#2e9c5a"
  semantic-warning: "#e08a2d"
  semantic-error: "#d6453d"
...
components:
  button-primary:
    ...
    rounded: "{rounded.lg}"
    padding: "12px 20px"
    shadow: "0 18px 30px -22px rgba(240, 106, 79, 0.7)"
  ...
  card-base:
    ...
    shadow: "0 18px 40px -28px rgba(19, 22, 35, 0.25)"
  card-feature:
  ...
  workspace-shell:
    ...
    border: "1px solid {colors.hairline-soft}"
    shadow: "0 28px 60px -38px rgba(19, 22, 35, 0.3)"
